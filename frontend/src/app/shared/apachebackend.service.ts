...
export class ApachebackendService {

  public loadedForSpinner:boolean=false;

  //private baseUrl = 'http://localhost:8080/apache/apps'
  //private baseUrlPost = 'http://localhost:8080/restinvokescript/'
  //private baseUrl = 'http://xlpwsm01:50012/apache/apps'
  //private baseUrlPost = 'http://xlpwsm01:50012/restinvokescript/'

  private baseUrl =  environment["apache.baseurl"];
